                ...
                <div class="p-5">
                  ...
                  <form class="user" action="/checklogin" method="post">
                   <%-- <div class="form-group">
                     ...
                     <div class="form-group">
                       <input type="text" class="form-control form-control-user" name="Name" id="exampleInputName" placeholder="Ancount">
                     </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="Password" id="exampleInputPassword" placeholder="Password">
                    </div>
                     <div class="form-group">
                       <input type="text" class="form-control form-control-user" name="code" id="code" placeholder="验证码" style="width:170px ">
                       <span><img src="code" onclick="checkCode()"></span>
                  ...
                  <div class="text-center">
                    <a class="small" href="register.jsp">注册</a>
                  </div>
                </div>
              </div>
            </div>
